...
def handle_message(event):
    ...
    if '開始遊戲' in msg:
        ...
        try:
            line_bot_api.reply_message(event.reply_token, TemplateSendMessage(alt_text='Buttons template',template=ButtonsTemplate(title='inflation 通膨', text='一種經濟現象，指一段時間內物價上升的幅度。')))
